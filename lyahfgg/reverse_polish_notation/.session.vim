...
silent only
cd ~/repositories/haskell/lyahfgg/reverse_polish_notation
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +32 ReversePolishCalc.hs
badd +5 ReversePolishCalcSpec.hs
badd +0 ~/repositories/haskell/lyahfgg/Chapter7Spec.hs
argglobal
silent! argdel *
edit ReversePolishCalcSpec.hs
